...
class StaffBillInfoFragmentUI(orderedDrink: MutableList<OrderedDrink>) : AnkoComponent<StaffBillInfoFragment> {

    internal lateinit var rlChecked: RelativeLayout
    internal lateinit var rlBanned:RelativeLayout
    ...
    override fun createView(ui: AnkoContext<StaffBillInfoFragment>) = with(ui) {
        coordinatorLayout {
