...
import cao.cuong.supership.supership.extension.commonRadioButton
import cao.cuong.supership.supership.extension.enableHighLightWhenClicked
import cao.cuong.supership.supership.ui.base.widget.CommonRadioButton
import org.jetbrains.anko.*

class SingleChooseItemUI : AnkoComponent<ViewGroup> {
    ...
    internal val radios = mutableListOf<CommonRadioButton>()
    ...
    override fun createView(ui: AnkoContext<ViewGroup>) = with(ui) {
        verticalLayout {
            ...
            for (i in 0 until MultiChooseItemUI.MAX_OPTION_ITEM) {
                commonRadioButton {
                    radios.add(this)
